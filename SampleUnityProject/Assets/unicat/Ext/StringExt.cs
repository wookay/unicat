...
namespace unicat
{
	public static class StringExt
	{
		...
		{
			return (int)Convert.ToSingle(self.TrimEnd('f'), System.Globalization.CultureInfo.InvariantCulture);
		}

		public static float to_float(this string self)
		{
			return Convert.ToSingle(self.TrimEnd('f'), System.Globalization.CultureInfo.InvariantCulture);
		}
